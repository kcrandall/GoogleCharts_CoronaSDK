		...
		<head>
		  ...
		  <script type="text/javascript">
		    ...
		    HTML = HTML .. [[
		      ...
		      var chart = new google.charts.Scatter(document.getElementById(']] .. elementByID .. [['));
		...
		HTML = [[ 
		  ...
		  <head>
		    ...
		    HTML = HTML .. [[
		        ...
		        var chart = new google.visualization.ScatterChart(document.getElementById(']] .. elementByID .. [['));
